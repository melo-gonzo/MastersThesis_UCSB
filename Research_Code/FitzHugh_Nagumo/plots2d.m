...
% a_vals=-0.09:0.001:0.09;
a_vals=round(linspace(-0.09,0.09,501),4);
% a_vals=-0.15:0.0005:.15;
% tau_vals=round(0:0.003:1,5);
...
%         final_vals(jj,ii)=sqrt(s.xy_recovered(end,1)^2+s.xy_recovered(end,2)^2)-sqrt(s.xp_short(end,1)^2+s.xp_short(end,2)^2);
